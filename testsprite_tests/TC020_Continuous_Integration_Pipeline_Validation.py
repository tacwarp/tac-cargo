"""
TC020: Bulk Actions with Shipments Data Table Test
Tests bulk shipment actions
"""
import asyncio
...
async def run_test():
    ...
    try:
        ...
        print("Step 3: Checking bulk action support...")
        checkboxes = await page.locator("input[type='checkbox']").count()
        print(f"✓ Found {checkboxes} checkboxes")
        
        print("\n" + "="*50)
        print("✅ TC020: Bulk Actions - PASSED")
        print("="*50)
    
    except Exception as e:
        print(f"\n❌ TC020: Bulk Actions - FAILED")
        print(f"Error: {str(e)}")
