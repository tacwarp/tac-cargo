"""
TC012: Exception Handling Workflow for Failed and Delayed Shipments Test
Tests exception handling functionality
"""
import asyncio
...
async def run_test():
    ...
    try:
        ...
        print("Step 3: Verifying exceptions content...")
        page_content = await page.locator("body").text_content()
        if "Exception" in page_content:
            print("✓ Exception content visible")
        
        print("\n" + "="*50)
        print("✅ TC012: Exception Workflow - PASSED")
        print("="*50)
    
    except Exception as e:
        print(f"\n❌ TC012: Exception Workflow - FAILED")
        print(f"Error: {str(e)}")
