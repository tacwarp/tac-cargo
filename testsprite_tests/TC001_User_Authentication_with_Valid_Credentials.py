...
async def run_test():
    ...
    try:
        ...
        # -> Input valid email and password credentials and click the INITIATE SESSION button.
        frame = context.pages[-1]
        # Input valid email into Operative ID field
        ...
        frame = context.pages[-1]
        # Input valid password into Security Key field
