...
:root {
  ...
  --muted-foreground: oklch(0.6 0.015 252); /* Muted text */
  ...
  /* Brand Colors */
  --primary: oklch(0.7 0.19 250); /* Primary brand */
  ...
  --glass: oklch(0.2 0.02 252 / 0.85); /* Glass morphism */
  ...
  --shadow-lg:
    0 10px 15px -3px oklch(0 0 0 / 0.5), 0 4px 6px -4px oklch(0 0 0 / 0.4);
  --shadow-xl:
    0 20px 25px -5px oklch(0 0 0 / 0.5), 0 8px 10px -6px oklch(0 0 0 / 0.4);
...
:root:not(.dark) {
  &:where(:not(.dark, .dark *)) {
    ...
    --shadow-lg:
      0 10px 15px -3px oklch(0 0 0 / 0.1), 0 4px 6px -4px oklch(0 0 0 / 0.08);
    --shadow-xl:
      0 20px 25px -5px oklch(0 0 0 / 0.12), 0 8px 10px -6px oklch(0 0 0 / 0.1);
...
.depth-surface {
  @apply bg-card text-card-foreground border-border/20 rounded-lg border;
  box-shadow: var(--shadow-lg);
}

.glass-card {
  @apply border-border/20 rounded-lg border backdrop-blur-xl;
  background: var(--glass);
  box-shadow: var(--shadow-xl);
}

.metric-card {
  @apply bg-card text-card-foreground border-border/30 rounded-lg border p-6;
...
<button className="bg-primary hover:bg-primary/90 focus:ring-ring focus:ring-2">
  Button
</button>
```
...
<Card className="bg-card">
  ...
  <CardContent className="text-card-foreground">Content</CardContent>
</Card>
```
...
```tsx
<aside className="bg-background border-border border-r">
...
```tsx
<button className="focus:ring-ring focus:ring-offset-background focus:ring-2 focus:ring-offset-2">
  Button
</button>
```
...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="bg-card text-foreground border-border/30 border"
    >
      Toggle Theme
    </button>
  );
