...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to Payments section to simulate a payment transaction.
        frame = context.pages[-1]
        # Click on 'Payments' in the Finance menu to access payment tracking and processing page
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Payment transaction successful').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: Payment transactions are not recorded accurately or reflected in payment tracking pages with correct status and timestamp updates as per the test plan.")
