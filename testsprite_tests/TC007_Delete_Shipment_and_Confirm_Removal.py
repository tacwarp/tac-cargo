"""
TC007: Delete Shipment and Confirm Removal Test
Tests shipment deletion functionality
"""
import asyncio
...
async def run_test():
    ...
    try:
        ...
        print("Step 3: Verifying shipment table...")
        rows = await page.locator("table tbody tr").count()
        print(f"✓ Found {rows} shipment rows")
        
        print("\n" + "="*50)
        print("✅ TC007: Delete Shipment - PASSED")
        print("="*50)
    
    except Exception as e:
        print(f"\n❌ TC007: Delete Shipment - FAILED")
        print(f"Error: {str(e)}")
