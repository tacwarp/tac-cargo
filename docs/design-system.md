...
export function Component() {
  return (
    <div className="bg-card text-card-foreground shadow-elevation-1">...</div>
  );
}
```
...
gray-_ muted / border
green-_ state-arrived / kpi-positive
red-_ destructive / state-delayed
shadow-lg shadow-elevation-_
