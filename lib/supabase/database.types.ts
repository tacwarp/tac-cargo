  ...
  public: {
    Tables: {
      ...
      exceptions: {
        ...
        Insert: Omit<Database['public']['Tables']['exceptions']['Row'], 'id' | 'created_at' | 'updated_at'>
      ...
      manifests: {
        ...
        Insert: Omit<Database['public']['Tables']['manifests']['Row'], 'id' | 'created_at' | 'updated_at'>
      ...
      manifest_shipments: {
        ...
        Insert: Omit<Database['public']['Tables']['manifest_shipments']['Row'], 'id'>
        Update: Partial<Database['public']['Tables']['manifest_shipments']['Insert']>
      }
      inventory: {
        Row: {
          id: string
      ...
      rate_cards: {
        ...
        Insert: Omit<Database['public']['Tables']['rate_cards']['Row'], 'id' | 'created_at' | 'updated_at'>
...
export type ManifestShipment = Database['public']['Tables']['manifest_shipments']['Row']
