...
export function generateShipmentSMS(data: { awbNo: string; status: string; trackingUrl: string }): string {
  ...
  return statusMessages[data.status] || `Shipment ${data.awbNo} update. Track: ${data.trackingUrl}`
}
