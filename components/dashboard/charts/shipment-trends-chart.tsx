...
export function ShipmentTrendsChart({ className }: ShipmentTrendsChartProps) {
  ...
  return (
    <Card className={cn('depth-surface noise-overlay border-none overflow-hidden', className)}>
      <CardHeader className='flex items-center gap-2 space-y-0 border-b border-border/30 py-4 sm:flex-row px-6'>
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger
            className='w-[130px] h-8 text-[10px] font-bold uppercase tracking-wide bg-muted/50 border-border/40'
          ...
          <AreaChart data={filteredData} margin={{ left: 0, right: 0 }}>
            <defs>
              <linearGradient id='fillShipments' x1='0' y1='0' x2='0' y2='1'>
                <stop offset='5%' stopColor='var(--color-shipments)' stopOpacity={0.6} />
