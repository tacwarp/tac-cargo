...
export function WorkspaceHeader({
  ...
  return (
    <div className={cn(
      'sticky top-0 z-10 flex items-center justify-between gap-4 border-b bg-background/95 px-6 py-4 backdrop-blur supports-[backdrop-filter]:bg-background/60',
      className
    )}>
...
export function WorkspaceBody({ children, className }: WorkspaceBodyProps) {
  return (
    <div className={cn('grid flex-1 gap-6 p-6 lg:grid-cols-[1fr,400px]', className)}>
      {children}
    </div>
  )
}
...
export function LivePreviewPanel({ children, className }: LivePreviewPanelProps) {
  return (
...
export function CostBreakdown({ items, total, currency = '₹' }: CostBreakdownProps) {
  return (
