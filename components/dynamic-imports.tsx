...
export const DynamicLottie = dynamic(
  () => import('@/components/ui/lottie-container').then(mod => mod.LottieContainer),
  {
...
export const DynamicBarcodeScanner = dynamic(
  () => import('@/components/dashboard/barcode-scanner').then(mod => mod.BarcodeScanner),
  {
    loading: GenericLoadingFallback,
    ssr: false,
  }
...
export const DynamicPDFViewer = dynamic(
  () => import('@/components/dashboard/pdf-viewer').then(mod => mod.PDFViewer).catch(() => () => null),
  {
    loading: GenericLoadingFallback,
    ssr: false,
  }
